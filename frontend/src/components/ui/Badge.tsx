...
export const Badge: React.FC<BadgeProps> = ({
  ...
  return (
    <span
      className={`inline-flex items-center gap-1 px-2.5 py-0.5 border-2 border-black rounded-lg text-xs font-black tracking-wide shadow-neo-sm ${badgeColorMap[color]} ${className}`}
    >
      {children}
    </span>
  );
